...
def train(args, train_dataset, model, tokenizer, pad_token_label_id):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            #     active_logits = decoder_predictions.view(-1, vocab_size)
            #     active_output_ids = torch.where(
            #         active_loss, output_ids.view(-1), torch.tensor(loss_fct.ignore_index).type_as(output_ids)
            #     )
